    ...
    <header className="sticky top-0 z-50 border-b border-black/8 bg-white/92 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <Link href="/metodo" className="text-sm font-medium text-black/80 hover:text-black">
            Metodo
          </Link>
          ...
          >
            ...
            <AnimatePresence>
              {isMegaOpen ? (
                ...
                >
                  <div className="rounded-3xl border border-black/10 bg-white p-7 backdrop-blur-[3px] shadow-[0_30px_70px_-42px_rgba(0,0,0,0.35)]">
                    ...
                    <motion.div
                      ...
                      initial="hidden"
                      animate="visible"
                      className="mt-5 grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-6"
                    >

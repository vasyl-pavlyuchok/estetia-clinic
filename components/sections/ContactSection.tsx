      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 md:px-10">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <article className="rounded-3xl border border-white/[0.22] bg-[linear-gradient(150deg,rgba(255,255,255,0.18)_0%,rgba(250,253,255,0.12)_56%,rgba(246,249,252,0.08)_100%)] p-6 backdrop-blur-[34px] backdrop-brightness-[0.98] backdrop-saturate-[1.4]">
            <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#7FAFC2]">{t('hoursLabel')}</p>
            <ul className="mt-3 space-y-1.5 text-sm text-white/75">
              <li>{t('hours1')}</li>
              <li>{t('hours2')}</li>
              <li>{t('hours3')}</li>
            </ul>
            <p className="mt-4 text-xs text-white/45">{t('hoursNote')}</p>
          </article>

          <article className="rounded-3xl border border-white/[0.22] bg-[linear-gradient(150deg,rgba(255,255,255,0.18)_0%,rgba(250,253,255,0.12)_56%,rgba(246,249,252,0.08)_100%)] p-6 backdrop-blur-[34px] backdrop-brightness-[0.98] backdrop-saturate-[1.4]">
            <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#7FAFC2]">{t('locationLabel')}</p>
            <p className="mt-3 text-sm font-medium text-white">{t('locationAddress')}</p>
            <p className="mt-1 text-xs text-white/60">{t('locationDistrict')}</p>
            <p className="mt-4 text-xs text-white/45">{t('locationNote')}</p>
          </article>
        </div>
      </div>
    </section>

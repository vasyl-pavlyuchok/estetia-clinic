...
export default function InductoresColageno() {
  const t = useTranslations('inductoresColageno');
  ...
  const benefits = [
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>, title: t('benefit2Title'), desc: t('benefit2Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>, title: t('benefit3Title'), desc: t('benefit3Desc') },
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, title: t('benefit5Title'), desc: t('benefit5Desc') },
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, title: t('benefit7Title'), desc: t('benefit7Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>, title: t('benefit8Title'), desc: t('benefit8Desc') },
  ];
  ...
  const steps = [
    ...
    { title: t('step7Title'), desc: t('step7Desc'), tag: t('massageNotice') },
      ...
      <div className={styles['hero-wrapper']}>
        <div className={styles['hero-image-col']}>
          ...
          <div className={styles['inductor-badge']}>
            <div className={styles['inductor-badge-label']}>{t('vsTitle')}</div>
            ...
            <div className={styles['inductor-stat-sub']}>{t('sculptraDuration')}</div>
            <div className={styles['inductor-divider']}></div>
            <div className={styles['product-list']}>
              <div className={styles['product-item']}><div className={styles['product-dot']}></div>{t('sculptraLabel')}</div>
              <div className={styles['product-item']}><div className={styles['product-dot']}></div>{t('radiessLabel')}</div>
            </div>
          </div>
        </div>
        ...
        <div className={styles['hero-content-col']}>
          ...
          <div className={styles['vs-block']}>
            <div className={styles['vs-cell']}>
              <div className={styles['vs-cell-label']}>{t('sculptraLabel')}</div>
              <div className={styles['vs-cell-value']}>{t('sculptraDesc')}</div>
            </div>
            <div className={`${styles['vs-cell']} ${styles.active}`}>
              <div className={styles['vs-cell-label']}>{t('radiessLabel')} ✦</div>
              <div className={styles['vs-cell-value']}>{t('radiessDesc')}</div>
            </div>
          </div>
          ...
          <div className={styles['meta-strip']}>
            ...
            <div className={styles['meta-cell']}>
              <div className={styles['m-label']}>{tC('metaResultado')}</div>
              <div className={styles['m-value']}>{t('metaResultadoVal')}</div>
            </div>
            <div className={styles['meta-cell']}>
          ...
          <div className={styles['hero-ctas']}>
            ...
            <a href="#productos" className={styles['btn-ghost']}>{t('vsTitle')}</a>
          </div>
        </div>
      </div>
      ...
      <div className={styles['scroll-section']} id="productos">
        <div className={styles['scroll-inner']}>
          ...
          <div className={`${styles['products-section']} ${styles.reveal}`} id="protocolo">
            ...
            <h2 className={styles['section-title']}>{t('vsSubtitle')}</h2>

            <div className={`${styles['products-grid']} ${styles['reveal-stagger']}`}>
              <div className={styles['product-card']}>
                <div className={styles['pc-label']}>{t('sculptraLabel')}</div>
                <div className={styles['pc-molecule']}>Ácido poli-L-láctico (PLLA)</div>
                <h3>{t('sculptraLabel')}®</h3>
                <p>{t('sculptraDesc')}</p>
                <div className={styles['pc-duration']}>{t('sculptraDuration')}</div>
              </div>
              <div className={`${styles['product-card']} ${styles['gold-card']}`}>
                <div className={styles['pc-label']}>{t('radiessLabel')}</div>
                <div className={styles['pc-molecule']}>Hidroxiapatita cálcica (CaHA)</div>
                <h3>{t('radiessLabel')}®</h3>
                <p>{t('radiessDesc')}</p>
                <div className={styles['pc-duration']}>{t('radiessDuration')}</div>
              </div>
            </div>
          </div>

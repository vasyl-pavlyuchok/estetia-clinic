...
export default function RadiofrecuenciaCorporalPage() {
  const t = useTranslations('radiofrecuenciaCorporal');
  ...
  const benefits = [
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>, title: t('benefit1Title'), desc: t('benefit1Desc') },
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>, title: t('benefit4Title'), desc: t('benefit4Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>, title: t('benefit5Title'), desc: t('benefit5Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>, title: t('benefit6Title'), desc: t('benefit6Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, title: t('benefit7Title'), desc: t('benefit7Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, title: t('benefit8Title'), desc: t('benefit8Desc') },
  ];
      ...
      <div className={styles['scroll-section']} id="protocolo">
        <div className={styles['scroll-inner']}>
          ...
          <div className={`${styles['celulitis-section']} ${styles.reveal}`}>
            <div className={styles.eyebrow}>{t('celulitisTitle')}</div>
            <div className={`${styles['celulitis-grid']} ${styles['reveal-stagger']}`}>
              <div className={styles['celulitis-card']}>
                <div className={`${styles['cel-grade']} ${styles['grade-1']}`}>{t('celulitis1Grade')}</div>
                <h3>{t('celulitis1Title')}</h3>
                <p>{t('celulitis1Desc')}</p>
              </div>
              <div className={styles['celulitis-card']}>
                <div className={`${styles['cel-grade']} ${styles['grade-2']}`}>{t('celulitis2Grade')}</div>
                <h3>{t('celulitis2Title')}</h3>
                <p>{t('celulitis2Desc')}</p>
              </div>
              <div className={styles['celulitis-card']}>
                <div className={`${styles['cel-grade']} ${styles['grade-3']}`}>{t('celulitis3Grade')}</div>
                <h3>{t('celulitis3Title')}</h3>
                <p>{t('celulitis3Desc')}</p>
              </div>
            </div>
          </div>

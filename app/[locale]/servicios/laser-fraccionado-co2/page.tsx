...
export default function LaserFraccionadoCO2Page() {
  const t = useTranslations('laserCo2');
  ...
  const benefits = [
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="36" height="36"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, title: t('benefit4Title'), desc: t('benefit4Desc') },
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="36" height="36"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>, title: t('benefit6Title'), desc: t('benefit6Desc') },
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="36" height="36"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>, title: t('benefit7Title'), desc: t('benefit7Desc') },
  ...
  const mecItems = [
    { num: t('mec1Num'), label: t('mec1Label') },
    { num: t('mec2Num'), label: t('mec2Label') },
    { num: t('mec3Num'), label: t('mec3Label') },
    { num: t('mec4Num'), label: t('mec4Label') },
  ];
        ...
        <div className={styles.heroContentCol}>
          ...
          <div className={styles.metaStrip}>
            ...
            <div className={styles.metaCell}>
              ...
              <div className={`${styles.mValue} ${styles.warn}`}>{t('metaRecoveryVal')}</div>
            </div>
            <div className={styles.metaCell}>
          ...
          <div className={styles.heroCtas}>
            ...
            <a href="#mecanismo" className={styles.btnGhost}>{tC('protocolTitle')}</a>
          </div>
        </div>
      </div>
        ...
        <div className={styles.scrollInner}>
          ...
          <div className={`${styles.mecSection} ${styles.reveal}`}>
            ...
            <div className={`${styles.mecGrid} ${styles.revealStagger}`}>
              {mecItems.map((m, i) => (
                <div key={i} className={styles.mecCard}>
                  <div className={styles.mecNum}>{m.num}</div>
                  <div className={styles.mecLabel}>{m.label}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className={`${styles.revealStagger}`} style={{display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'1px', background:'var(--border)', border:'1px solid var(--border)', marginTop:'32px', marginBottom:'80px'}}>
              ...
              {vsRows.map((row, i) => (
                <>
                  ...
                  <div key={`i${i}`} className={styles.vsCell}><div className={styles.vsCellValue}>{row.ipl}</div></div>
                  <div key={`c${i}`} className={`${styles.vsCell} ${styles.active}`}><div className={styles.vsCellValue}>{row.co2}</div></div>
                </>
              ))}
            </div>
          </div>
